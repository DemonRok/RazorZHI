...
namespace Assistant
{
    ...
    {
        public ContainerContent(List<Item> items) : this(items, EngineZHI221523.UsePostKRPackets)
        {
        }
    ...
    {
        public ContainerItem(Item item) : this(item, EngineZHI221523.UsePostKRPackets)
        {
        }
