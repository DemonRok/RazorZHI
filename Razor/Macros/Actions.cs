...
namespace Assistant.Macros
{
    ...
    /*public class LiftAction : MacroWaitAction
    {
        ...
        {
            if (InputBox.Show(EngineZHI160922.MainWindow, Language.GetString(LocString.EnterAmount),
    ...
    public class OverheadMessageAction : MacroAction
    {
        ...
        private void SetHue(object[] args)
        {
            ...
            if (h.ShowDialog(EngineZHI160922.MainWindow) == DialogResult.OK)
            {
                _hue = (ushort)h.Hue;
            }
    ...
    public class WaitForMenuAction : MacroWaitAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertWait(this).ShowDialog(EngineZHI160922.MainWindow);
        }
    }
    ...
    public class IfAction : MacroAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertIf(this).ShowDialog(EngineZHI160922.MainWindow);
        }
    }
    ...
    public class WhileAction : MacroAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertWhile(this).ShowDialog(EngineZHI160922.MainWindow);
        }
    }
    ...
    public class DoWhileAction : MacroAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertDoWhile(this).ShowDialog(EngineZHI160922.MainWindow);
        }
    }
