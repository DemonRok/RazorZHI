...
namespace Assistant
{
    ...
    {
        public ContainerContent(List<Item> items) : this(items, EngineZHI120226.UsePostKRPackets)
        {
        }
    ...
    {
        public ContainerItem(Item item) : this(item, EngineZHI120226.UsePostKRPackets)
        {
        }
