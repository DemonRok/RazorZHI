...
namespace Assistant.Macros
{
    public class MacroManager
    {
        ...
        {
            EngineZHI160922.EnsureDirectory(Config.GetUserDirectory("Macros"));
        ...
        public static void PlayAt(Macro m, int at)
        {
            ...
            if (EngineZHI160922.MainWindow.WaitDisplay != null)
                EngineZHI160922.MainWindow.SafeAction(s => s.WaitDisplay.Text = "");
        }
        ...
        public static void HotKeyPlay(Macro m)
        {
            if (m != null)
            {
                ...
                EngineZHI160922.MainWindow.SafeAction(s => s.PlayMacro(m));
            }
        }
        ...
        public static void Stop(bool restartPrev)
        {
            ...
            EngineZHI160922.MainWindow.SafeAction(s => s.OnMacroStop());
        ...
        public static void Pause()
        {
            ...
            else
            {
                ...
                if (EngineZHI160922.MainWindow.WaitDisplay != null)
                    EngineZHI160922.MainWindow.SafeAction(s => s.WaitDisplay.Text = "Paused");
