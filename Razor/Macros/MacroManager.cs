...
namespace Assistant.Macros
{
    public class MacroManager
    {
        ...
        {
            EngineZHI.EnsureDirectory(Config.GetUserDirectory("Macros"));
        ...
        public static void PlayAt(Macro m, int at)
        {
            ...
            if (EngineZHI.MainWindow.WaitDisplay != null)
                EngineZHI.MainWindow.SafeAction(s => s.WaitDisplay.Text = "");
        }
        ...
        public static void HotKeyPlay(Macro m)
        {
            if (m != null)
            {
                ...
                EngineZHI.MainWindow.SafeAction(s => s.PlayMacro(m));
            }
        }
        ...
        public static void Stop(bool restartPrev)
        {
            ...
            EngineZHI.MainWindow.SafeAction(s => s.OnMacroStop());
        ...
        public static void Pause()
        {
            ...
            else
            {
                ...
                if (EngineZHI.MainWindow.WaitDisplay != null)
                    EngineZHI.MainWindow.SafeAction(s => s.WaitDisplay.Text = "Paused");
