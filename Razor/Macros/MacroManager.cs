...
namespace Assistant.Macros
{
    public class MacroManager
    {
        ...
        {
            EngineZHI120226.EnsureDirectory(Config.GetUserDirectory("Macros"));
        ...
        public static void PlayAt(Macro m, int at)
        {
            ...
            if (EngineZHI120226.MainWindow.WaitDisplay != null)
                EngineZHI120226.MainWindow.SafeAction(s => s.WaitDisplay.Text = "");
        }
        ...
        public static void HotKeyPlay(Macro m)
        {
            if (m != null)
            {
                ...
                EngineZHI120226.MainWindow.SafeAction(s => s.PlayMacro(m));
            }
        }
        ...
        public static void Stop(bool restartPrev)
        {
            ...
            EngineZHI120226.MainWindow.SafeAction(s => s.OnMacroStop());
        ...
        public static void Pause()
        {
            ...
            else
            {
                ...
                if (EngineZHI120226.MainWindow.WaitDisplay != null)
                    EngineZHI120226.MainWindow.SafeAction(s => s.WaitDisplay.Text = "Paused");
