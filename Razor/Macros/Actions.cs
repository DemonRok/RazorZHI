...
namespace Assistant.Macros
{
    ...
    /*public class LiftAction : MacroWaitAction
    {
        ...
        {
            if (InputBox.Show(EngineZHI221523.MainWindow, Language.GetString(LocString.EnterAmount),
    ...
    public class WaitForMenuAction : MacroWaitAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertWait(this).ShowDialog(EngineZHI221523.MainWindow);
        }
    }
    ...
    public class IfAction : MacroAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertIf(this).ShowDialog(EngineZHI221523.MainWindow);
        }
    }
    ...
    public class WhileAction : MacroAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertWhile(this).ShowDialog(EngineZHI221523.MainWindow);
        }
    }
    ...
    public class DoWhileAction : MacroAction
    {
        ...
        private void Edit(object[] args)
        {
            new MacroInsertDoWhile(this).ShowDialog(EngineZHI221523.MainWindow);
        }
    }
