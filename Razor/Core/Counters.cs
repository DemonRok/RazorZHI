...
namespace Assistant
{
    ...
    public class Counter : IComparable
    {
        ...
        private void OnUpdate()
        {
            ...
            if (m_Count != newValue)
            {
                if (m_Enabled)
                {
                    ...
                    //EngineZHI120226.MainWindow.RefreshCounters();
        ...
        private static void Load()
        {
            ...
            {
                MessageBox.Show(EngineZHI120226.ActiveWindow, Language.GetString(LocString.CounterFux),
        ...
        public static void Register(Counter c)
        {
            m_List.Add(c);
            m_NeedXMLSave = true;
            EngineZHI120226.MainWindow.SafeAction(s => s.RedrawCounters());
        }
