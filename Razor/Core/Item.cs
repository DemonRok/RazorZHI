...
namespace Assistant
{
    ...
    public class Item : UOEntity
    {
        ...
        private static List<Serial> _autoStackCache = new List<Serial>();

        public void AutoStackResource()
        {
            if (!IsResource || !Config.GetBool("AutoStack") || _autoStackCache.Contains(Serial))
                return;
