...
namespace Assistant
{
    ...
    {
        public ContainerContent(List<Item> items) : this(items, EngineZHI151124.UsePostKRPackets)
        {
        }
    ...
    {
        public ContainerItem(Item item) : this(item, EngineZHI151124.UsePostKRPackets)
        {
        }
